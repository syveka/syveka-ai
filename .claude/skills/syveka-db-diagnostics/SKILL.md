...
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `42P05` prepared statement "sN" already exists / `bind message supplies N parameters, but prepared statement requires M` | named prepared statements reused across multiplexed transaction-pooler backends. Check: which client produced it (runtime `PrismaPg` vs a script/CLI using the classic engine), port 6543, `pgbouncer=true` present for classic-engine paths, any code creating its own `PrismaClient`/`pg` client bypassing `src/server/db/prisma.ts` |
