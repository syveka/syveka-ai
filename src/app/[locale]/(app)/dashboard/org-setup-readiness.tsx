 ...
 * "Ready" for something unconfigured, never shows a fabricated "Blocked"
 * state nothing in this codebase can actually detect yet. Takes the
 * already-authorized dashboard `ctx` as a prop rather than re-deriving it —
 * the dashboard page has already called `requirePermission("crm:read")`.
 */
