...
BEGIN
  ...
  FOR expected IN
    SELECT * FROM (VALUES
      ('access_reviews', 'actions_taken', 'text', 'false', '', '', ''),
      ('access_reviews', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('access_reviews', 'findings_summary', 'text', 'true', '', '', ''),
      ('access_reviews', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('access_reviews', 'next_review_due_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('access_reviews', 'performed_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('access_reviews', 'performed_by_user_id', 'uuid', 'false', '', '', ''),
      ('access_reviews', 'review_key', 'text', 'true', '', '', ''),
      ('access_reviews', 'scope', '"AccessReviewScope"', 'true', '', '', ''),
      ('access_reviews', 'stale_access_found', 'boolean', 'true', '', '', 'false'),
      ...
      ('certifications', 'certification_type', 'text', 'true', '', '', ''),
      ('certifications', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('certifications', 'expiry_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('certifications', 'framework', '"ComplianceFramework"', 'true', '', '', ''),
      ('certifications', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('certifications', 'issue_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('certifications', 'issuer', 'text', 'false', '', '', ''),
      ('certifications', 'scope', 'text', 'true', '', '', ''),
      ('certifications', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('certifications', 'verification_reference', 'text', 'false', '', '', ''),
      ('certifications', 'verification_state', '"ClaimVerificationState"', 'true', '', '', '''internally_reviewed'''),
      ...
      ('compliance_audit_log', 'action', 'text', 'true', '', '', ''),
      ('compliance_audit_log', 'actor_type', 'text', 'true', '', '', '''user'''),
      ('compliance_audit_log', 'actor_user_id', 'uuid', 'false', '', '', ''),
      ('compliance_audit_log', 'after', 'jsonb', 'false', '', '', ''),
      ('compliance_audit_log', 'before', 'jsonb', 'false', '', '', ''),
      ('compliance_audit_log', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('compliance_audit_log', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('compliance_audit_log', 'ip', 'text', 'false', '', '', ''),
      ('compliance_audit_log', 'resource_id', 'text', 'false', '', '', ''),
      ('compliance_audit_log', 'resource_type', 'text', 'true', '', '', ''),
      ('compliance_audit_log', 'user_agent', 'text', 'false', '', '', ''),
      ('compliance_controls', 'category', '"ControlCategory"', 'true', '', '', ''),
      ('compliance_controls', 'control_key', 'text', 'true', '', '', ''),
      ('compliance_controls', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('compliance_controls', 'description', 'text', 'true', '', '', ''),
      ('compliance_controls', 'exception_notes', 'text', 'false', '', '', ''),
      ('compliance_controls', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('compliance_controls', 'implementation_notes', 'text', 'false', '', '', ''),
      ('compliance_controls', 'implementation_status', '"ControlImplementationStatus"', 'true', '', '', '''missing'''),
      ('compliance_controls', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('compliance_controls', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('compliance_controls', 'title', 'text', 'true', '', '', ''),
      ('compliance_controls', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('compliance_controls', 'verification_state', '"ClaimVerificationState"', 'true', '', '', '''technically_implemented'''),
      ('compliance_evidence', 'collected_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('compliance_evidence', 'content_hash', 'text', 'false', '', '', ''),
      ('compliance_evidence', 'control_id', 'uuid', 'true', '', '', ''),
      ('compliance_evidence', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('compliance_evidence', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('compliance_evidence', 'result_status', '"EvidenceResultStatus"', 'true', '', '', ''),
      ('compliance_evidence', 'review_due_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('compliance_evidence', 'source_identifier', 'text', 'true', '', '', ''),
      ('compliance_evidence', 'source_type', '"EvidenceSourceType"', 'true', '', '', ''),
      ('compliance_evidence', 'summary', 'text', 'true', '', '', ''),
      ('compliance_risks', 'asset_or_system', 'text', 'true', '', '', ''),
      ('compliance_risks', 'category', 'text', 'true', '', '', ''),
      ('compliance_risks', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('compliance_risks', 'description', 'text', 'true', '', '', ''),
      ('compliance_risks', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('compliance_risks', 'impact', '"RiskLevel"', 'true', '', '', ''),
      ('compliance_risks', 'inherent_risk_level', '"RiskLevel"', 'true', '', '', ''),
      ('compliance_risks', 'likelihood', '"RiskLevel"', 'true', '', '', ''),
      ('compliance_risks', 'mitigation_control_id', 'uuid', 'false', '', '', ''),
      ('compliance_risks', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('compliance_risks', 'residual_risk_level', '"RiskLevel"', 'false', '', '', ''),
      ('compliance_risks', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('compliance_risks', 'risk_key', 'text', 'true', '', '', ''),
      ('compliance_risks', 'status', '"RiskStatus"', 'true', '', '', '''open'''),
      ('compliance_risks', 'threat_description', 'text', 'true', '', '', ''),
      ('compliance_risks', 'title', 'text', 'true', '', '', ''),
      ('compliance_risks', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('control_framework_mappings', 'control_id', 'uuid', 'true', '', '', ''),
      ('control_framework_mappings', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('control_framework_mappings', 'framework', '"ComplianceFramework"', 'true', '', '', ''),
      ('control_framework_mappings', 'framework_reference', 'text', 'true', '', '', ''),
      ('control_framework_mappings', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('control_framework_mappings', 'notes', 'text', 'false', '', '', ''),
      ('conversation_documents', 'conversation_id', 'uuid', 'true', '', '', ''),
      ...
      ('conversations', 'user_id', 'uuid', 'true', '', '', ''),
      ('data_subject_requests', 'assigned_owner_user_id', 'uuid', 'false', '', '', ''),
      ('data_subject_requests', 'completed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('data_subject_requests', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('data_subject_requests', 'deadline_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('data_subject_requests', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('data_subject_requests', 'identity_verification_status', '"IdentityVerificationStatus"', 'true', '', '', '''unverified'''),
      ('data_subject_requests', 'received_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('data_subject_requests', 'rejection_reason', 'text', 'false', '', '', ''),
      ('data_subject_requests', 'related_organization_id', 'uuid', 'false', '', '', ''),
      ('data_subject_requests', 'request_key', 'text', 'true', '', '', ''),
      ('data_subject_requests', 'request_type', '"DsrType"', 'true', '', '', ''),
      ('data_subject_requests', 'status', '"DsrStatus"', 'true', '', '', '''received'''),
      ('data_subject_requests', 'subject_contact_reference', 'text', 'true', '', '', ''),
      ('data_subject_requests', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('documents', 'uploaded_by_id', 'uuid', 'true', '', '', ''),
      ('dsr_events', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('dsr_events', 'created_by_user_id', 'uuid', 'false', '', '', ''),
      ('dsr_events', 'description', 'text', 'true', '', '', ''),
      ('dsr_events', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('dsr_events', 'occurred_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('dsr_events', 'request_id', 'uuid', 'true', '', '', ''),
      ...
      ('incident_events', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('incident_events', 'created_by_user_id', 'uuid', 'false', '', '', ''),
      ('incident_events', 'description', 'text', 'true', '', '', ''),
      ('incident_events', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('incident_events', 'incident_id', 'uuid', 'true', '', '', ''),
      ('incident_events', 'occurred_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('pipelines', 'organization_id', 'uuid', 'true', '', '', ''),
      ('policy_acknowledgements', 'acknowledged_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('policy_acknowledgements', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('policy_acknowledgements', 'policy_id', 'uuid', 'true', '', '', ''),
      ('policy_acknowledgements', 'user_id', 'uuid', 'true', '', '', ''),
      ('privacy_security_assessments', 'assessment_key', 'text', 'true', '', '', ''),
      ('privacy_security_assessments', 'assessment_type', '"AssessmentType"', 'true', '', '', ''),
      ('privacy_security_assessments', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('privacy_security_assessments', 'dpia_required', '"DpiaRequirement"', 'true', '', '', '''unknown'''),
      ('privacy_security_assessments', 'feature_or_system', 'text', 'true', '', '', ''),
      ('privacy_security_assessments', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('privacy_security_assessments', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('privacy_security_assessments', 'reason', 'text', 'true', '', '', ''),
      ('privacy_security_assessments', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('privacy_security_assessments', 'review_status', '"ReviewStatus"', 'true', '', '', '''unknown'''),
      ('privacy_security_assessments', 'risks_identified', 'text', 'false', '', '', ''),
      ('privacy_security_assessments', 'safeguards', 'text', 'false', '', '', ''),
      ('privacy_security_assessments', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('processing_records', 'activity_key', 'text', 'true', '', '', ''),
      ('processing_records', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('processing_records', 'data_categories', 'text', 'true', '', '', ''),
      ('processing_records', 'data_subject_categories', 'text', 'true', '', '', ''),
      ('processing_records', 'dpia_status', '"DpiaRequirement"', 'true', '', '', '''unknown'''),
      ('processing_records', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('processing_records', 'international_transfers', 'text', 'false', '', '', ''),
      ('processing_records', 'lawful_basis', '"LawfulBasis"', 'true', '', '', ''),
      ('processing_records', 'name', 'text', 'true', '', '', ''),
      ('processing_records', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('processing_records', 'processor_notes', 'text', 'false', '', '', ''),
      ('processing_records', 'purpose', 'text', 'true', '', '', ''),
      ('processing_records', 'recipients', 'text', 'false', '', '', ''),
      ('processing_records', 'retention_period', 'text', 'true', '', '', ''),
      ('processing_records', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('processing_records', 'safeguards', 'text', 'false', '', '', ''),
      ('processing_records', 'system_location', 'text', 'false', '', '', ''),
      ('processing_records', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('retention_executions', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('retention_executions', 'data_category', 'text', 'true', '', '', ''),
      ('retention_executions', 'executed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('retention_executions', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('retention_executions', 'notes', 'text', 'false', '', '', ''),
      ('retention_executions', 'record_count', 'integer', 'false', '', '', ''),
      ('retention_executions', 'retention_policy_id', 'uuid', 'false', '', '', ''),
      ('retention_executions', 'scheduled_for', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('retention_executions', 'status', '"RetentionExecutionStatus"', 'true', '', '', '''scheduled'''),
      ('retention_policies', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('retention_policies', 'data_category', 'text', 'true', '', '', ''),
      ('retention_policies', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('retention_policies', 'legal_hold_supported', 'boolean', 'true', '', '', 'true'),
      ('retention_policies', 'notes', 'text', 'false', '', '', ''),
      ('retention_policies', 'retention_period', 'text', 'true', '', '', ''),
      ('retention_policies', 'tenant_overridable', 'boolean', 'true', '', '', 'false'),
      ('retention_policies', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('security_incidents', 'affected_data_categories', 'text', 'false', '', '', ''),
      ('security_incidents', 'affected_organization_id', 'uuid', 'false', '', '', ''),
      ('security_incidents', 'affected_systems', 'text', 'false', '', '', ''),
      ('security_incidents', 'closed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_incidents', 'containment_notes', 'text', 'false', '', '', ''),
      ('security_incidents', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('security_incidents', 'description', 'text', 'true', '', '', ''),
      ('security_incidents', 'detected_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('security_incidents', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('security_incidents', 'incident_key', 'text', 'true', '', '', ''),
      ('security_incidents', 'notification_authority_due_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_incidents', 'notification_early_warning_due_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_incidents', 'notification_final_report_due_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_incidents', 'notification_required', '"NotificationRequirement"', 'true', '', '', '''unknown'''),
      ('security_incidents', 'occurred_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_incidents', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('security_incidents', 'postmortem_ref', 'text', 'false', '', '', ''),
      ('security_incidents', 'remediation_notes', 'text', 'false', '', '', ''),
      ('security_incidents', 'severity', '"IncidentSeverity"', 'true', '', '', ''),
      ('security_incidents', 'status', '"IncidentStatus"', 'true', '', '', '''detected'''),
      ('security_incidents', 'title', 'text', 'true', '', '', ''),
      ('security_incidents', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('security_policies', 'acknowledgement_required', 'boolean', 'true', '', '', 'false'),
      ('security_policies', 'approved_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_policies', 'approved_by_user_id', 'uuid', 'false', '', '', ''),
      ('security_policies', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('security_policies', 'document_ref', 'text', 'true', '', '', ''),
      ('security_policies', 'effective_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_policies', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('security_policies', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('security_policies', 'policy_key', 'text', 'true', '', '', ''),
      ('security_policies', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('security_policies', 'status', '"PolicyStatus"', 'true', '', '', '''draft'''),
      ('security_policies', 'title', 'text', 'true', '', '', ''),
      ('security_policies', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('security_policies', 'version', 'text', 'true', '', '', ''),
      ('stripe_webhook_events', 'attempts', 'integer', 'true', '', '', '0'),
      ('stripe_webhook_events', 'completed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('stripe_webhook_events', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('stripe_webhook_events', 'event_type', 'text', 'true', '', '', ''),
      ('stripe_webhook_events', 'first_seen_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('stripe_webhook_events', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('stripe_webhook_events', 'last_attempt_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('stripe_webhook_events', 'last_error', 'text', 'false', '', '', ''),
      ('stripe_webhook_events', 'object_id', 'text', 'false', '', '', ''),
      ('stripe_webhook_events', 'organization_id', 'uuid', 'false', '', '', ''),
      ('stripe_webhook_events', 'status', '"StripeWebhookEventStatus"', 'true', '', '', '''received'''),
      ('stripe_webhook_events', 'stripe_event_id', 'text', 'true', '', '', ''),
      ('stripe_webhook_events', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('subprocessors', 'active', 'boolean', 'true', '', '', 'true'),
      ('subprocessors', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('subprocessors', 'data_categories', 'text', 'true', '', '', ''),
      ('subprocessors', 'data_residency', 'text', 'false', '', '', ''),
      ('subprocessors', 'dpa_status', '"DpaStatus"', 'true', '', '', '''unknown'''),
      ('subprocessors', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('subprocessors', 'international_transfer', '"TransferSafeguard"', 'true', '', '', '''unknown'''),
      ('subprocessors', 'name', 'text', 'true', '', '', ''),
      ('subprocessors', 'notes', 'text', 'false', '', '', ''),
      ('subprocessors', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('subprocessors', 'region', 'text', 'false', '', '', ''),
      ('subprocessors', 'review_date', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('subprocessors', 'risk_level', '"RiskLevel"', 'true', '', '', '''medium'''),
      ('subprocessors', 'role', '"SubprocessorRole"', 'true', '', '', '''subprocessor'''),
      ('subprocessors', 'security_review_status', '"ReviewStatus"', 'true', '', '', '''unknown'''),
      ('subprocessors', 'service_purpose', 'text', 'true', '', '', ''),
      ('subprocessors', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
  ...
  FOR expected IN
    SELECT * FROM (VALUES
      ...
      ('public', 'control_framework_mappings', 'control_framework_mappings_control_id_fkey', '{control_id}', 'public', 'compliance_controls', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'compliance_evidence', 'compliance_evidence_control_id_fkey', '{control_id}', 'public', 'compliance_controls', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'compliance_risks', 'compliance_risks_mitigation_control_id_fkey', '{mitigation_control_id}', 'public', 'compliance_controls', '{id}', 'SetNull', 'Cascade', 'false', 'false', 'true'),
      ('public', 'policy_acknowledgements', 'policy_acknowledgements_policy_id_fkey', '{policy_id}', 'public', 'security_policies', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'incident_events', 'incident_events_incident_id_fkey', '{incident_id}', 'public', 'security_incidents', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'dsr_events', 'dsr_events_request_id_fkey', '{request_id}', 'public', 'data_subject_requests', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'retention_executions', 'retention_executions_retention_policy_id_fkey', '{retention_policy_id}', 'public', 'retention_policies', '{id}', 'SetNull', 'Cascade', 'false', 'false', 'true')
    ) AS contract(
