...
BEGIN
  ...
  FOR expected IN
    SELECT * FROM (VALUES
      ...
      ('business_dna', 'payment_policy', 'text', 'false', '', '', ''),
      ('business_dna', 'policies', 'text', 'false', '', '', ''),
      ('business_dna', 'pricing_notes', 'text', 'false', '', '', ''),
      ('business_dna', 'products_services', 'text', 'false', '', '', ''),
      ('business_dna', 'quote_instructions', 'text', 'false', '', '', ''),
      ('business_dna', 'refund_policy', 'text', 'false', '', '', ''),
      ('business_dna', 'response_instructions', 'text', 'false', '', '', ''),
      ...
      ('business_dna', 'timezone', 'text', 'false', '', '', ''),
      ('business_dna', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('business_dna_services', 'business_dna_id', 'uuid', 'true', '', '', ''),
      ('business_dna_services', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('business_dna_services', 'description', 'text', 'false', '', '', ''),
      ('business_dna_services', 'duration_minutes', 'integer', 'false', '', '', ''),
      ('business_dna_services', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('business_dna_services', 'is_active', 'boolean', 'true', '', '', 'true'),
      ('business_dna_services', 'name', 'text', 'true', '', '', ''),
      ('business_dna_services', 'organization_id', 'uuid', 'true', '', '', ''),
      ('business_dna_services', 'price_cents', 'integer', 'false', '', '', ''),
      ('business_dna_services', 'price_note', 'text', 'false', '', '', ''),
      ('business_dna_services', 'sort_order', 'integer', 'true', '', '', '0'),
      ('business_dna_services', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('conversations', 'user_id', 'uuid', 'true', '', '', ''),
      ('creator_campaigns', 'approval_mode', '"CreatorCampaignApprovalMode"', 'true', '', '', '''approval'''),
      ('creator_campaigns', 'autopilot_enabled', 'boolean', 'true', '', '', 'false'),
      ('creator_campaigns', 'autopilot_rules', 'jsonb', 'false', '', '', ''),
      ('creator_campaigns', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_campaigns', 'created_by_id', 'uuid', 'true', '', '', ''),
      ('creator_campaigns', 'ends_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_campaigns', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_campaigns', 'name', 'text', 'true', '', '', ''),
      ('creator_campaigns', 'objective', 'text', 'false', '', '', ''),
      ('creator_campaigns', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_campaigns', 'starts_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_campaigns', 'status', '"CreatorCampaignStatus"', 'true', '', '', '''draft'''),
      ('creator_campaigns', 'target_languages', '"Locale"[]', 'true', '', '', 'array[]'),
      ('creator_campaigns', 'target_platforms', '"SocialPlatform"[]', 'true', '', '', 'array[]'),
      ('creator_campaigns', 'target_posts_per_week', 'integer', 'false', '', '', ''),
      ('creator_campaigns', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('creator_credit_balances', 'available_credits', 'integer', 'true', '', '', '0'),
      ('creator_credit_balances', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_credit_balances', 'reserved_credits', 'integer', 'true', '', '', '0'),
      ('creator_credit_balances', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('creator_credit_grants', 'amount', 'integer', 'true', '', '', ''),
      ('creator_credit_grants', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_credit_grants', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_credit_grants', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_credit_grants', 'period_start', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('creator_credit_transactions', 'amount', 'integer', 'true', '', '', ''),
      ('creator_credit_transactions', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_credit_transactions', 'created_by_id', 'uuid', 'false', '', '', ''),
      ('creator_credit_transactions', 'generation_id', 'uuid', 'false', '', '', ''),
      ('creator_credit_transactions', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_credit_transactions', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_credit_transactions', 'reason', 'text', 'false', '', '', ''),
      ('creator_credit_transactions', 'type', '"CreditTransactionType"', 'true', '', '', ''),
      ('creator_generations', 'completed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_generations', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_generations', 'created_by_id', 'uuid', 'true', '', '', ''),
      ('creator_generations', 'creator_profile_id', 'uuid', 'false', '', '', ''),
      ('creator_generations', 'credits_consumed', 'integer', 'true', '', '', '0'),
      ('creator_generations', 'credits_reserved', 'integer', 'true', '', '', '0'),
      ('creator_generations', 'error_code', 'text', 'false', '', '', ''),
      ('creator_generations', 'error_message_safe', 'text', 'false', '', '', ''),
      ('creator_generations', 'generation_type', '"CreatorGenerationType"', 'true', '', '', ''),
      ('creator_generations', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_generations', 'idempotency_key', 'text', 'false', '', '', ''),
      ('creator_generations', 'input_asset_ids', 'text[]', 'true', '', '', 'array[]'),
      ('creator_generations', 'latency_ms', 'integer', 'false', '', '', ''),
      ('creator_generations', 'model', 'text', 'true', '', '', ''),
      ('creator_generations', 'negative_prompt', 'text', 'false', '', '', ''),
      ('creator_generations', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_generations', 'output', 'jsonb', 'false', '', '', ''),
      ('creator_generations', 'output_asset_ids', 'text[]', 'true', '', '', 'array[]'),
      ('creator_generations', 'prompt', 'text', 'true', '', '', ''),
      ('creator_generations', 'provider', 'text', 'true', '', '', ''),
      ('creator_generations', 'provider_request_id', 'text', 'false', '', '', ''),
      ('creator_generations', 'request_fingerprint', 'text', 'false', '', '', ''),
      ('creator_generations', 'status', '"CreatorGenerationStatus"', 'true', '', '', '''queued'''),
      ('creator_generations', 'template_id', 'uuid', 'false', '', '', ''),
      ('creator_posts', 'approval_status', '"CreatorPostApprovalStatus"', 'true', '', '', '''draft'''),
      ('creator_posts', 'approved_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_posts', 'approved_by_id', 'uuid', 'false', '', '', ''),
      ('creator_posts', 'approved_content_version', 'integer', 'false', '', '', ''),
      ('creator_posts', 'asset_ids', 'text[]', 'true', '', '', 'array[]'),
      ('creator_posts', 'campaign_id', 'uuid', 'false', '', '', ''),
      ('creator_posts', 'caption', 'text', 'false', '', '', ''),
      ('creator_posts', 'content_version', 'integer', 'true', '', '', '1'),
      ('creator_posts', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_posts', 'created_by_id', 'uuid', 'true', '', '', ''),
      ('creator_posts', 'creator_profile_id', 'uuid', 'false', '', '', ''),
      ('creator_posts', 'external_post_id', 'text', 'false', '', '', ''),
      ('creator_posts', 'hashtags', 'text[]', 'true', '', '', 'array[]'),
      ('creator_posts', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_posts', 'last_error_code', 'text', 'false', '', '', ''),
      ('creator_posts', 'last_error_safe', 'text', 'false', '', '', ''),
      ('creator_posts', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_posts', 'platform', '"SocialPlatform"', 'true', '', '', ''),
      ('creator_posts', 'publish_attempt_count', 'integer', 'true', '', '', '0'),
      ('creator_posts', 'publish_status', '"CreatorPostPublishStatus"', 'true', '', '', '''not_scheduled'''),
      ('creator_posts', 'published_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_posts', 'scheduled_for', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_posts', 'social_account_id', 'uuid', 'false', '', '', ''),
      ('creator_posts', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('creator_profiles', 'avatar_asset_id', 'uuid', 'false', '', '', ''),
      ('creator_profiles', 'consent_confirmed_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('creator_profiles', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_profiles', 'description', 'text', 'false', '', '', ''),
      ('creator_profiles', 'display_name', 'text', 'true', '', '', ''),
      ('creator_profiles', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_profiles', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_profiles', 'owner_user_id', 'uuid', 'false', '', '', ''),
      ('creator_profiles', 'slug', 'text', 'true', '', '', ''),
      ('creator_profiles', 'status', '"CreatorProfileStatus"', 'true', '', '', '''draft'''),
      ('creator_profiles', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ('creator_reference_assets', 'asset_type', 'text', 'true', '', '', ''),
      ('creator_reference_assets', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_reference_assets', 'creator_profile_id', 'uuid', 'true', '', '', ''),
      ('creator_reference_assets', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_reference_assets', 'mime_type', 'text', 'true', '', '', ''),
      ('creator_reference_assets', 'organization_id', 'uuid', 'true', '', '', ''),
      ('creator_reference_assets', 'size_bytes', 'integer', 'true', '', '', ''),
      ('creator_reference_assets', 'source', '"CreatorAssetSource"', 'true', '', '', '''upload'''),
      ('creator_reference_assets', 'storage_path', 'text', 'true', '', '', ''),
      ('creator_reference_assets', 'validation_status', '"CreatorAssetValidationStatus"', 'true', '', '', '''pending'''),
      ('creator_templates', 'active', 'boolean', 'true', '', '', 'true'),
      ('creator_templates', 'aspect_ratio', 'text', 'true', '', '', ''),
      ('creator_templates', 'category', 'text', 'true', '', '', ''),
      ('creator_templates', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('creator_templates', 'generation_type', '"CreatorGenerationType"', 'true', '', '', ''),
      ('creator_templates', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('creator_templates', 'metadata', 'jsonb', 'true', '', '', '''{}'''),
      ('creator_templates', 'name', 'text', 'true', '', '', ''),
      ('creator_templates', 'organization_id', 'uuid', 'false', '', '', ''),
      ('creator_templates', 'prompt_template', 'text', 'true', '', '', ''),
      ('creator_templates', 'slug', 'text', 'true', '', '', ''),
      ('creator_templates', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
      ...
      ('social_accounts', 'access_token_enc', 'text', 'false', '', '', ''),
      ('social_accounts', 'created_at', 'timestamp(3) without time zone', 'true', '', '', 'current_timestamp'),
      ('social_accounts', 'display_name', 'text', 'true', '', '', ''),
      ('social_accounts', 'external_account_id', 'text', 'true', '', '', ''),
      ('social_accounts', 'id', 'uuid', 'true', '', '', 'gen_random_uuid'),
      ('social_accounts', 'last_checked_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('social_accounts', 'last_error', 'text', 'false', '', '', ''),
      ('social_accounts', 'organization_id', 'uuid', 'true', '', '', ''),
      ('social_accounts', 'platform', '"SocialPlatform"', 'true', '', '', ''),
      ('social_accounts', 'refresh_token_enc', 'text', 'false', '', '', ''),
      ('social_accounts', 'scopes', 'text[]', 'true', '', '', 'array[]'),
      ('social_accounts', 'status', '"ConnectionStatus"', 'true', '', '', '''connected'''),
      ('social_accounts', 'token_expires_at', 'timestamp(3) without time zone', 'false', '', '', ''),
      ('social_accounts', 'updated_at', 'timestamp(3) without time zone', 'true', '', '', ''),
  ...
  FOR expected IN
    SELECT * FROM (VALUES
      ...
      ('public', 'business_dna_services', 'business_dna_services_organization_id_fkey', '{organization_id}', 'public', 'organizations', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
      ('public', 'business_dna_services', 'business_dna_services_business_dna_id_fkey', '{business_dna_id}', 'public', 'business_dna', '{id}', 'Cascade', 'Cascade', 'false', 'false', 'true'),
