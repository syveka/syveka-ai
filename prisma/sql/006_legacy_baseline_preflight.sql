...
BEGIN
  ...
  FOR expected IN
    SELECT * FROM (VALUES
      ...
      ('booking_types', 'is_ai_booking_default', 'boolean', 'true', '', '', 'false'),
      ...
      ('calendar_events', 'google_sync_error', 'text', 'false', '', '', ''),
      ('calendar_events', 'google_sync_status', '"GoogleSyncStatus"', 'true', '', '', '''not_applicable'''),
