...
-- public":
--   - business_dna: SELECT, INSERT, UPDATE, DELETE -- this table has real
--       client policies (business_dna_select/_insert/_update/_delete), and
--       the assertions exercise all four to prove RLS's USING/WITH CHECK
